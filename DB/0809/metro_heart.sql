...
CREATE TABLE `heart` (
  ...
  KEY `FK7m28hqo8x7tu7rfguc4i1ps8u` (`member_username`),
  CONSTRAINT `FK197ewge8jbxp2sfnm7f64bhdo` FOREIGN KEY (`board_id`) REFERENCES `board` (`id`),
  CONSTRAINT `FK7m28hqo8x7tu7rfguc4i1ps8u` FOREIGN KEY (`member_username`) REFERENCES `member` (`username`)
...
-- Dump completed on 2023-08-09 17:33:37
